...
import { crearEsp32,editarEsp32, eliminarEsp32, buscarEsp32PorCodigo, buscarEsp32PorIdCtrl } from "../controllers/esp32.controller";
...
router.get("/byid/:id", authMiddleware(["admin"]), buscarEsp32PorIdCtrl);
//aaa
